(function () {
  const zh = {
    ...
    vox: 'VOX 声控发射',
    voxEnable: '软件声控发射 (VOX)',
    voxEnableText: '麦克风电平超过开门阈值时自动发射',
    voxOpenDb: 'VOX 开门阈值 (-80..-10 dBFS)',
    voxCloseDb: 'VOX 关门阈值 (-90..-15 dBFS)',
    voxAttackMs: 'VOX 开门确认 (0-500 ms)',
    voxHangMs: 'VOX 挂尾 (100-3000 ms)',
    voxLevel: '麦克风电平 (实时)',
    hpfEq: '高通滤波 / EQ',
